...
async function setupEtherRouter (interfaceContract, deployedImplementations, resolver) {
...
async function setupUpgradableToken (token, resolver, etherRouter) {
...
async function setupColonyVersionResolver (colony, colonyTask, colonyFunding, resolver, colonyNetwork) {
  const deployedImplementations = {}
...
async function setupUpgradableColonyNetwork (etherRouter, resolver, colonyNetwork, colonyNetworkStaking, colonyNetworkAuction) {
  const deployedImplementations = {}
